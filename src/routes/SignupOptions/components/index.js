      ...
      <React.Fragment>
            ...
            <div className="row">
              <div className="col-12 welcome-text">
                ...
                <div className="btn-my-sec text-center">
                  <Button
                    label={literals.welcome.butonRegister}
                    href="/signup"
                  />

                  <a className="link-anonymous" onClick={this.showTerms}>
                    {literals.welcome.enterAnonymously}
                  </a>
                </div>
              </div>
            </div>
        ...
        {showTerms && (
          <Terms
            ...
            literals={literals.welcome}
            onContinue={this.handleContinueAnonymous}
          />
        )}
      </React.Fragment>
    );
